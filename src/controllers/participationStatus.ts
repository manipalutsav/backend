...
const create = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const statues = participationStatuses.map((obj: any) => new ParticipationStatus(obj))
 ...
 * @returns {void}
 */
const getByCollege = async (req: Request, res: Response) => {
...
const getByEvent = async (req: Request, res: Response) => {
